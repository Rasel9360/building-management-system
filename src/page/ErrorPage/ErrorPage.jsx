    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen'>
            ...
            <div className='text-center space-y-3'>
                ...
                <div>
                    <Link >
                        <p className='w-1/2 mx-auto flex justify-center items-center gap-1 text-xl font-bold font-serif text-blue-900 btn btn-outline'><FaArrowAltCircleLeft /> Go Back Home</p>
                    </Link>
                </div>
            </div>
        </div>
