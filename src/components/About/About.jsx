        ...
        <div className='bg-[#EBF8FE]'>
            <div className='w-10/12 mx-auto'>
                ...
                <div className='md:flex items-center gap-20 pb-20'>
                    <Slide duration={1500} className="md:w-1/2 overflow-hidden shadow-xl ">
                        <img
                            className='h-[36rem] w-full rounded hover:scale-110 transition-transform object-center object-cover'
                            src={image}
                            alt="building photo" />
                    </Slide>
                    <Slide direction='right' duration={1500} className="md:w-1/2">
                        <p className='font-sev text-2xl lg:text-3xl text-justify mt-10 md:mt-0 text-black'>
