    ...
    return (
        <div>
            <div className="bg-line relative p-10 rounded-md bg-gradient-to-r from-[#01236b] to-[#965EF0] text-center font-jura text-white text-lg space-y-3 hover:scale-105">
                ...
                <div className="w-8 h-8 absolute -right-4 bottom-[40%] rounded-full bg-base-100 "></div>
                <div className="w-8 h-8 absolute -left-4 bottom-[40%] rounded-full bg-base-100 "></div>
            </div>
        </div>
    );
};
